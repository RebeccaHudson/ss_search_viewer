...
def  copy_valid_form_data_into_hidden_fields(form_data):
    fields_to_copy = ['raw_requested_snpids', \
...
def handle_search_by_snpid(request):
    ...
    pvalue_dict = PValueDictFromForm.get_pvalues_from_form(snpid_search_form)
    form_data['pvalue_rank_cutoff'] = pvalue_dict['pvalue_rank_cutoff'] #drop in the default
